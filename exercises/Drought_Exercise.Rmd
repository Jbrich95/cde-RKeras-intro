...
*·* You can think of v.validation as a multivariate time series of coefficients that we can use to reconstruct SST anomaly from the EOFs.
...
```{r, eval = T}
history <- model %>% fit(
  x = X.rnn.train, y = Y.rnn.train, verbose=0,
